...
abstract class AppointmentManagementBaseForm extends FormBase {
   ...
   */
  protected function getVerifiedAppointment(): ?ContentEntityInterface {
   ...
   */
  protected function setVerifiedAppointment(ContentEntityInterface $appointment, string $normalized_phone): void {
   ...
   */
  protected function clearVerification(): void {
   ...
   */
  protected function loadByReference(string $reference): ?ContentEntityInterface {
   ...
   */
  protected function sendAppointmentMail(string $key, ContentEntityInterface $appointment): void {
   ...
   */
  protected function getStatusLabel(ContentEntityInterface $appointment): string {
   ...
   */
  protected function buildAppointmentSummaryMarkup(ContentEntityInterface $appointment): string {
   ...
   */
  protected function formatAppointmentDate(ContentEntityInterface $appointment): string {
